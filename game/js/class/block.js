...
import PropertyLine from "../class/property.js";
/* Block Class */
...
export default class Block {
    ...
    */
    ...
    setCorners () {
        //this.groundLayer.weightedRandomize(TILES.HEDGE.FILL_, this.block.left, this.block.top,1, 1);
        //this.groundLayer.weightedRandomize(TILES.HEDGE.FILL_, this.block.right, this.block.top,1, 1);
        //this.groundLayer.weightedRandomize(TILES.HEDGE.FILL_, this.block.left, this.block.bottom,1, 1);
        //this.groundLayer.weightedRandomize(TILES.HEDGE.FILL_, this.block.right, this.block.bottom,1, 1);
